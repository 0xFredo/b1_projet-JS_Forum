...
func main() {
	...
	http.HandleFunc("/tips", handlers.Tips)
	...
	http.HandleFunc("/depeches", handlers.Depeches)
	http.HandleFunc("/commere", handlers.CommereCreatePost)
	http.HandleFunc("/api/user-role", handlers.APIUserRole)
